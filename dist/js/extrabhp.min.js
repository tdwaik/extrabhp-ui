...
app.controller("aboutController",["$scope","$timeout","feedbackService",function(t,c,n){t.contact={email:null,content:null,loading:!1,showThankYou:!1,submitFailure:!1,submit:function(){t.contact.loading=!0,t.contact.showThankYou=!1,n.submitFeedback(t.contact.email,t.contact.content).then(function(c){201===c.status?t.contact.submitSuccess():t.contact.submitFaild()},function(){t.contact.submitFaild()})},submitSuccess:function(){t.contact.loading=!1,t.contact.showThankYou=!0,t.contact.submitFailure=!1,c(function(){t.contact.resetForm()},1e3)},submitFaild:function(){t.contact.loading=!1,t.contact.submitFailure=!0},resetForm:function(){t.contact.email=null,t.contact.content=null,t.contact.loading=!1,t.contact.submitFailure=!1}}}]);
app.controller("carsTimelineController",["$scope","carsTimelineService",function(e,i){e.loading=!0,e.timelineDate=null,e.timelineByYear={},e.timelineYears=[];var n=2;e.isTimelineDate=function(i,n){return null===e.timelineDate?(n&&(e.timelineDate=i),!0):e.timelineDate!==i&&(n&&(e.timelineDate=i),!0)},e.init=function(){i.getTimeline().then(function(i){e.timeline=i.data,angular.forEach(e.timeline,function(i){var n=i.productionDate.substr(-4);e.timelineYears.indexOf(n)<0&&e.timelineYears.push(n),void 0===e.timelineByYear[n]&&(e.timelineByYear[n]=[]),e.timelineByYear[n].push(i)}),console.log(e.timelineByYear),e.loading=!1},function(i){n-- >0&&e.init()})}}]);
app.controller("homeController",["$scope",function(o){}]);
app.controller("mainController",["$rootScope","$scope","$location","$anchorScroll","feedbackService","$timeout",function(e,a,c,n,t,o){e.alerts=[],e.pushAlert=function(a,c){e.alerts.push({type:a,message:c})},e.closeAlert=function(a){e.alerts.slice(1,a)},e.$on("$locationChangeStart",function(){}),e.scrollTo=function(e){var a=c.hash();c.hash(e),n(),c.hash(a)},a.contactUs={submit:function(){grecaptcha.execute()}},a.feedback={email:null,content:null,loading:!1,showThankYou:!1,submitFailure:!1,submit:function(){a.feedback.loading=!0,t.submitFeedback(a.feedback.email,a.feedback.content).then(function(e){201===e.status?a.feedback.submitSuccess():a.feedback.submitFaild()},function(){a.feedback.submitFaild()})},submitSuccess:function(){a.feedback.loading=!1,a.feedback.showThankYou=!0,a.feedback.submitFailure=!1,o(function(){$("#feedback").modal("hide")},1e3),o(function(){a.feedback.resetForm()},2500)},submitFaild:function(){a.feedback.loading=!1,a.feedback.submitFailure=!0},resetForm:function(){a.feedback.email=null,a.feedback.content=null,a.feedback.loading=!1,a.feedback.showThankYou=!1,a.feedback.submitFailure=!1}}}]);
app.controller("petrolhead101Controller",["$scope",function(e){e.dictionary=[{code:"Petrolhead",name:"Petrolhead",content:"Car Enthusiast"},{code:"JDM",name:"JDM",content:"Japanese domestic market"},{code:"Muscle_car",name:"Muscle Car",content:"American term used to refer to a variety of high-performance automobiles"},{code:"ABS",name:"ABS (Anti-lock braking system)",content:"An anti-lock braking system or anti-skid braking system (ABS) is an automobile safety system that allows the wheels on a motor vehicle to maintain tractive contact with the road surface according to driver inputs while braking, preventing the wheels from locking up (ceasing rotation) and avoiding uncontrolled skidding."},{code:"ESC",name:"ESC / ESP / DSC / ASC",content:"Electronic stability control (ESC), also referred to as electronic stability program (ESP) or dynamic stability control (DSC), is a computerized technology that improves a vehicle's stability by detecting and reducing loss of traction (skidding). When ESC detects loss of steering control, it automatically applies the brakes to help \"steer\" the vehicle where the driver intends to go. Braking is automatically applied to wheels individually, such as the outer front wheel to counter oversteer or the inner rear wheel to counter understeer. Some ESC systems also reduce engine power until control is regained. ESC does not improve a vehicle's cornering performance; instead, it helps to minimize the loss of control."},{code:"Powertrain",name:"Powertrain",content:"The mechanism that transmits the drive from the engine of a vehicle to its axle."}]}]);
app.controller("whatCarController",["$scope","$timeout","alerts","whatCarService",function(e,n,o,s){var t=null;e.getQuestion=function(){e.loading=!0,s.getQuestion(e.answers).then(function(n){200===n.status?(e.question=n.data,void 0!==e.question.type&&"multiple_choice"===e.question.type&&e.question.answers.forEach(function(e){this[e.value]=!1},e.checkboxModel),e.loading=!1):201===n.status?(e.result=n.data.result,e.loading=!1,t=n.data.whatCarLogId):o.oops()},function(e){o.oops()})},e.submitAnswer=function(n,o){e.answers[n]=o,e.getQuestion()},e.submitCheckboxModel=function(n){e.answers[n]=e.getCheckedBoxesValue(),e.checkboxModel={},e.getQuestion()},e.getCheckedBoxesValue=function(){console.log(e.checkboxModel);var n=[];return angular.forEach(e.checkboxModel,function(e,n){e===!0&&this.push(n)},n),n.join(",")},e.init=function(){e.answers={},e.question=null,e.result=null,e.checkboxModel={},e.loading=!0,e.isHelpful.show=!0,e.isHelpful.loading=!1,e.feedback.show=!1,e.feedback.loading=!1,e.feedback.value=null,e.showThanks=!1,t=null,e.getQuestion()},e.tryAgain=function(){e.init()},e.isHelpful={show:!0,loading:!1,send:function(n){e.isHelpful.loading=!0,s.sendIsHelpful(t,n).then(function(n){e.isHelpful.loading=!1,e.isHelpful.show=!1,e.feedback.show=!0},function(e){o.oops()})}},e.feedback={show:!1,loading:!1,value:null,send:function(){e.feedback.loading=!0,s.sendFeedback(t,e.feedback.value).then(function(o){e.feedback.loading=!1,e.feedback.show=!1,e.showThanks=!0,n(function(){e.showThanks=!1},1e3)},function(e){o.oops()})}},e.back=function(){var n=null;angular.forEach(e.answers,function(e,o){n=o}),delete e.answers[n],e.getQuestion()},e.showBack=function(){return JSON.stringify(e.answers)!==JSON.stringify({})}}]);
