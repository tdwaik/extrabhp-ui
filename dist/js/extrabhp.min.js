...
app.controller("carsTimelineController",["$scope","carsTimelineService",function(t,e){t.loading=!0,e.getTimeline().then(function(e){t.timeline=e.data,t.loading=!1},function(t){alerts.oops()}),t.shareFB=function(t){var e="http://extrabhp.com/car-timeline#"+t.code;$("#og-url").attr("content")?$("#og-url").attr("content",e):$("head").append('<meta id="og-url" property="og:url" content="'+e+'" />'),$("#og-title").attr("content")?$("#og-title").attr("content",t.title):$("head").append('<meta id="og-title" property="og:title" content="'+t.title+'" />'),$("#og-description").attr("content")?$("#og-description").attr("content",t.description):$("head").append('<meta id="og-description" property="og:description" content="'+t.description+'" />'),$("#og-image").attr("content")?$("#og-image").attr("content",t.img):$("head").append('<meta id="og-image" property="og:image" content="'+t.img+'" />')}}]);
...
app.controller("mainController",["$rootScope","$scope","$location",function(t,o,a){t.alerts=[],t.pushAlert=function(o,a){t.alerts.push({type:o,message:a})},t.closeAlert=function(o){t.alerts.slice(1,o)},t.$on("$locationChangeStart",function(){$(window).off(".affix"),$("#mainNav").removeData("bs.affix").removeClass("affix affix-top affix-bottom"),$("#mainNav").affix({offset:{top:"/"===a.path()?50:-1}})}),o.contactUs={submit:function(){grecaptcha.execute()}}}]);
