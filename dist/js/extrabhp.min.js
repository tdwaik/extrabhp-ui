...
app.controller("carsTimelineController",["$scope","carsTimelineService",function(e,i){e.loading=!0,e.timelineDate=null,e.isTimelineDate=function(i){return null!==e.timelineDate?e.timelineDate!==i&&(e.timelineDate=i,!0):void(e.timelineDate=i)},e.init=function(){i.getTimeline().then(function(i){e.timeline=i.data,e.loading=!1},function(e){})}}]);
