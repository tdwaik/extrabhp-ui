...
app.controller("aboutController",["$scope","$timeout","feedbackService",function(t,c,n){t.contact={email:null,content:null,loading:!1,showThankYou:!1,submitFailure:!1,submit:function(){t.contact.loading=!0,n.submitFeedback(t.contact.email,t.contact.content).then(function(c){201===c.status?t.contact.submitSuccess():t.contact.submitFaild()},function(){t.contact.submitFaild()})},submitSuccess:function(){t.contact.loading=!1,t.contact.showThankYou=!0,t.contact.submitFailure=!1,c(function(){t.contact.resetForm()},1e3)},submitFaild:function(){t.contact.loading=!1,t.contact.submitFailure=!0},resetForm:function(){t.contact.email=null,t.contact.content=null,t.contact.loading=!1,t.contact.showThankYou=!1,t.contact.submitFailure=!1}}}]);
