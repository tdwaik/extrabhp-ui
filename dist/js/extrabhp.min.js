...
var APIEndPoint="http://extrabhp.com:8080";app.service("API",["$http",function(t){return{call:function(n,r,e){return t({method:n,url:APIEndPoint+r,data:e})}}}]),app.service("whatCarService",["API",function(t){this.getQuestion=function(n){return t.call("post","/whatCar",n)}}]);
app.controller("homeController",["$scope","alerts","whatCarService",function(e,o,n){e.answers=[],e.question=null,e.result=null,e.checkboxModel={},e.loading=!0,e.getQuestion=function(){e.loading=!0,n.getQuestion(e.answers).then(function(n){200===n.status?(e.question=n.data,void 0!==e.question.type&&"multiple_choice"===e.question.type&&e.question.answers.forEach(function(e){this[e.value]=!1},e.checkboxModel),e.loading=!1):201===n.status?(e.result=n.data,e.loading=!1):o.oops()},function(e){o.oops()})},e.submitAnswer=function(o,n){e.answers[o]=n,e.getQuestion()},e.submitCheckboxModel=function(o){e.answers[o]=e.getCheckedBoxesValue(),e.checkboxModel={},e.getQuestion()},e.getCheckedBoxesValue=function(){console.log(e.checkboxModel);var o=[];return angular.forEach(e.checkboxModel,function(e,o){e===!0&&this.push(o)},o),o.join(",")},e.init=function(){e.getQuestion()},e.tryAgain=function(){e.answers=[],e.question=null,e.result=null,e.checkboxModel={},e.loading=!0,e.init()}}]);
