...
app.config(["$routeProvider","$locationProvider",function(e,l){e.when("/",{templateUrl:"/assets/view/homeView.html",controller:"homeController"}).when("/petrolhead-101",{templateUrl:"/assets/view/petrolhead101View.html",controller:"petrolhead101Controller"}).when("/404",{templateUrl:"/assets/view/404.html"}).when("/cars-timeline",{templateUrl:"/assets/view/carsTimelineView.html",controller:"carsTimelineController"}).otherwise({templateUrl:"/assets/view/404.html"}),l.html5Mode({enabled:!0})}]);
