...
var APIEndPoint="https://extrabhp.com:8443",UIEndPoint="https://extrabhp.com";app.service("API",["$http",function(t){return{call:function(n,e,a,r){return t({method:n,url:APIEndPoint+e,data:a,headers:r})}}}]),app.service("UI",["$http",function(t){return{call:function(n,e,a,r){return t({method:n,url:UIEndPoint+e,data:a,headers:r})}}}]),app.service("whatCarService",["API",function(t){this.getQuestion=function(n){var e={"Content-Type":"application/x-www-form-urlencoded"};return t.call("post","/whatCar",n,e)},this.sendIsHelpful=function(n,e){var a={whatCarLogId:n,isHelpful:e},r={"Content-Type":"application/json"};return t.call("post","/whatCar/isHelpful",JSON.stringify(a),r)},this.sendFeedback=function(n,e){var a={whatCarLogId:n,feedback:e},r={"Content-Type":"application/json"};return t.call("post","/whatCar/feedback",JSON.stringify(a),r)}}]),app.service("UIService",["UI",function(t){this.getModal=function(n){return t.call("get","/assets/modal/"+n+".html")}}]);
